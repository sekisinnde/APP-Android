...
import com.example.oumar.topquiz.model.Question;
import com.example.oumar.topquiz.model.QuestionBank;

import java.util.Arrays;

public class GameActivity<onClick> extends AppCompatActivity implements View.OnClickListener {
